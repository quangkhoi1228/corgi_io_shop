...
const Home: React.FC = () => {
  ...
  const handleRenderSingleEggItem = (el: any) => {
    ...
    return (
      <div className="list-item egg-item" key={el.id}>
        <Link to={`${itemCate}${el.id}`} className="detail"></Link>
        <div className="egg-content">
          ...
          <p className="button shop-buy-button">
  ...
  const handleRenderComboEggItem = (el: any) => {
    ...
    return (
      <div className="list-item egg-item is-combo" key={el.id}>
        <Link to={`${itemCate}${el.id}`} className="detail"></Link>
        <div className="egg-content">
  ...
  const handleRenderComboItemItem = (el: any) => {
    ...
    return (
      <div className="list-item item-item is-combo" key={el.id}>
        <Link to={`${itemCate}${el.id}`} className="detail"></Link>
